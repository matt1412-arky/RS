<form id="specializationForm" method="post" action="/api/spesialisasi/edit/{{$editspecialization->id}}">
    @csrf
    <div class="container-fluid px-3">
        <div class="row mt-0">
            <h4>Ubah Nama Spesialisasi*</h4>
        </div>
        <div class="row mt-2">
            <input name="user_id" id="user_id" hidden>
            <input id="name" name="name" class="form-control" value="{{$editspecialization->name}}">
